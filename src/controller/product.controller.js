...
async function productbyfilterwithname(req,res){
    try{
...
module.exports = {createproduct,getproducts,getproductbysku,getproductbycategory,productbyfilterwithname,updateproduct,deleteproduct}