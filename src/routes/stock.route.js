...
// router.post("/increaseproduct/:id",authMiddleware,async(req,res)=>{
//     try{
...
// router.post("/decreaseproduct/:id",authMiddleware,async(req,res)=>{
//     try{
//         const UserRole = req.user_role
//         if(UserRole !== "admin"){
//            return res.status(401).json({message : "Not Authorized"})
...
// router.get("/getstockhistory",authMiddleware,async(req,res)=>{
//     try{
...
// router.get("/getstocksummary",authMiddleware,async(req,res)=>{
//     try{
//         const pageNumber = parseInt(req.query.page) || 1;
//         const limitNumber = Math.min(parseInt(req.query.limit) || 10, 100); // cap at 100
//         const skip = (pageNumber - 1) * limitNumber;
...
// router.get("/getstockhistorybydate",authMiddleware,async(req,res)=>{
//     try{
